...
data816=pd.read_csv('257_acquirer_gvkeys.csv')
data816=data816[250:257]        

dataorig=data

data816gvkeylist=data816["gvkey"].tolist()
print data816gvkeylist
data816gvkeylist=list(set(data816gvkeylist))
data816gvkeylist.sort()
print data816gvkeylist
uniqlength816=[]
density816=[]
finalsum816=[]
...
for gvkeys in data816gvkeylist:
	...
	dealyearlist=data816["deal year"][data816["gvkey"]==gvkeys].tolist()
	for dy in dealyearlist:
		dealyear=dy
	#	print dealyear		

		with open('Acquirer Density Files/{}_{}ps.txt'.format(gvkeys,dealyear), 'w') as output:
	...
	#		density816.append(density)
		...
		with open('densityfile_acquirer.txt','a') as file:
			file.write("%d %d %d %.10f %.10f\n"%(gvkeys,dealyear,uniqlength,fnlsum,density))
